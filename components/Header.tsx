...
export default function Header() {
  ...
  return (
    ...
    >
      <nav className="container flex items-center justify-between border-b border-[var(--seperator-color)] py-4">
        ...
        <div
          className={`lg:flex w-full justify-between ${
            menuOpen ? "flex-col space-y-4 h-full" : "hidden space-x-4"
          }`}
        >
          <div
            className={`lg:flex ${
          ...
          >
            ...
            <Link href="/contact" className="light-link py-2 px-4">
              Contact
            </Link>
          </div>
          <div
            className={`flex ${
              menuOpen ? "flex-col space-y-2" : "space-x-4 items-center"
            }`}
          >
            <div className="light-link flex items-center w-fit py-2 px-4">
              <SignedOut>
                <SignInButton />
              </SignedOut>
              <SignedIn>
